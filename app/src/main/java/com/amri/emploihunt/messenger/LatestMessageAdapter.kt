...
class LatestMessageAdapter(
    ...
    inner class LatestMsgViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        fun bind(messageData: LatestChatMsg, userId: String){
            ...
            cardView.setOnClickListener {
                onChatClickListener.onChatClick(absoluteAdapterPosition,messageData.user)
            }
            cardView.setOnLongClickListener {
                onChatClickListener.onChatLongClick(absoluteAdapterPosition,messageData.user)
    ...
    interface OnChatClickListener{
        fun onChatClick(position: Int,usersRecruiter: User)
        fun onChatLongClick(position: Int,usersRecruiter: User)
    }
